...
import { TemplehsThemeType } from '../TemplehsSettings';
...
type PaletteSelectorProps = {
	...
	value: TemplehsThemeType;
	onChange: (value: TemplehsThemeType) => void;
};
...
function PaletteSelector(props: PaletteSelectorProps) {
	...
	const methods = useForm<TemplehsThemeType>({
		defaultValues: {},
		mode: 'onChange'
	});
	...
	function onSubmit(formData: TemplehsThemeType) {
		onChange(formData);
		handleCloseDialog();
	}
