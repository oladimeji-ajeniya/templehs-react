import { templehsDark } from 'src/@templehs/colors';
...
/**
 * The defaultSettings object defines the default settings for the Templehs application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the Templehs application.
 * It returns a TemplehsSettingsConfigType object that can be used to configure the application.
 */
export function getParsedQuerySettings() {
	...
	if (typeof defaultSettings === 'string') {
		...
		return JSON.parse(defaultSettings) as TemplehsSettingsConfigType;
	}
