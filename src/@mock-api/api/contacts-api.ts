...
import ContactModel from 'src/app/pages/doctor/models/ContactModel';
import mockApi from '../mock-api.json';
import mock from '../mock';
import { ContactType, ContactsType } from '../../app/pages/doctor/types/ContactType';
...
mock.onPost('/api/contacts').reply(({ data }) => {
	const newContact = ContactModel({ id: TemplehsUtils.generateGUID(), ...JSON.parse(data as string) } as ContactType);
