...
import NotificationTemplate from 'src/app/theme-layouts/shared-components/notificationPanel/NotificationTemplate';
import NotificationModel from 'src/app/theme-layouts/shared-components/notificationPanel/models/NotificationModel';
	...
	return (
		...
		>
			<IconButton
				...
				size="large"
			>
				<TemplehsSvgIcon color="action">heroicons-outline:x</TemplehsSvgIcon>
			</IconButton>
			{notifications.length > 0 ? (
				<TemplehsScrollbars className="p-16">
