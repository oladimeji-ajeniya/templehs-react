				...
				<List>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<TemplehsSvgIcon>material-outline:notifications</TemplehsSvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<TemplehsSvgIcon>material-outline:cloud</TemplehsSvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<TemplehsSvgIcon>material-outline:brightness_high</TemplehsSvgIcon>
						</ListItemIcon>
