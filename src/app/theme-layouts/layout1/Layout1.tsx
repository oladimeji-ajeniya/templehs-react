...
import TemplehsSuspense from '@templehs/core/TemplehsSuspense/TemplehsSuspense';
import TemplehsMessage from '@templehs/core/TemplehsMessage/TemplehsMessage';
import TemplehsDialog from '@templehs/core/TemplehsDialog/TemplehsDialog';
			...
			<div className="flex min-w-0 flex-auto">
				...
				>
					...
					<div className="relative z-10 flex min-h-0 flex-auto flex-col">
						<TemplehsDialog />
						<TemplehsSuspense>{useRoutes(routes)}</TemplehsSuspense>
						{children}
					</div>
