	...
	return (
		...
		>
						...
						InputProps={{
							startAdornment: (
								<InputAdornment position="start">
									<TemplehsSvgIcon size={20}>heroicons-solid:mail</TemplehsSvgIcon>
								</InputAdornment>
							)
						}}
					/>
				...
				render={({ field }) => (
					<TextField
						...
						InputProps={{
							startAdornment: (
								<InputAdornment position="start">
									<TemplehsSvgIcon size={20}>heroicons-solid:tag</TemplehsSvgIcon>
								</InputAdornment>
							)
						}}
					/>
			...
			{!hideRemove && (
				...
				>
					<TemplehsSvgIcon size={20}>heroicons-solid:trash</TemplehsSvgIcon>
				</IconButton>
			)}
		</form>
	);
