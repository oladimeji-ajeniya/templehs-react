...
function BirtdayIcon() {
	return <TemplehsSvgIcon size={20}>heroicons-solid:cake</TemplehsSvgIcon>;
}
...
function ContactForm() {
	...
	if (_.isEmpty(form) || !contact) {
		return <TemplehsLoading className="min-h-screen" />;
	}
									...
									<div className="absolute inset-0 flex items-center justify-center z-20">
										<div>
											...
											>
												...
												/>
												<TemplehsSvgIcon className="text-white">
										...
										<div>
											...
											>
												<TemplehsSvgIcon className="text-white">heroicons-solid:trash</TemplehsSvgIcon>
											</IconButton>
										</div>
									</div>
									<Avatar
							...
							InputProps={{
								startAdornment: (
									<InputAdornment position="start">
										<TemplehsSvgIcon size={20}>heroicons-solid:user-circle</TemplehsSvgIcon>
									</InputAdornment>
								)
							}}
						/>
					...
					render={({ field }) => (
						<TextField
							...
							InputProps={{
								startAdornment: (
									<InputAdornment position="start">
										<TemplehsSvgIcon size={20}>heroicons-solid:briefcase</TemplehsSvgIcon>
									</InputAdornment>
								)
							}}
						/>
					...
					render={({ field }) => (
						<TextField
							...
							InputProps={{
								startAdornment: (
									<InputAdornment position="start">
										<TemplehsSvgIcon size={20}>heroicons-solid:office-building</TemplehsSvgIcon>
									</InputAdornment>
								)
							}}
						/>
					...
					render={({ field }) => (
						<TextField
							...
							InputProps={{
								startAdornment: (
									<InputAdornment position="start">
										<TemplehsSvgIcon size={20}>heroicons-solid:location-marker</TemplehsSvgIcon>
									</InputAdornment>
								)
							}}
						/>
							...
							InputProps={{
								...
								startAdornment: (
									<InputAdornment
										...
										position="start"
									>
										<TemplehsSvgIcon size={20}>heroicons-solid:menu-alt-2</TemplehsSvgIcon>
									</InputAdornment>
								)
							}}
						/>
