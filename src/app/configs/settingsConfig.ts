...
/**
 * The settingsConfig object is a configuration object for the Templehs application's settings.
 */
const settingsConfig: TemplehsSettingsConfigType = {
	/**
