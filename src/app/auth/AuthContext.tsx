...
import { logoutUser, setUser } from 'src/app/store/user/userSlice';
import { useAppDispatch } from 'src/app/store';
import { AxiosError } from 'axios';
import { UserType } from 'src/app/store/user';
import jwtService from './services/jwtService';
import { showMessage } from 'src/app/store/templehs/messageSlice';
import TemplehsSplashScreen from '@templehs/core/TemplehsSplashScreen/TemplehsSplashScreen';
...
function AuthProvider(props: AuthProviderProps) {
	...
	return waitAuthCheck ? <TemplehsSplashScreen /> : <AuthContext.Provider value={val}>{children}</AuthContext.Provider>;
}
