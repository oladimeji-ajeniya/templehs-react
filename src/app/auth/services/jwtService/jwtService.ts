import TemplehsUtils from 'src/@templehs/utils/TemplehsUtils';
...
/**
 * The JwtService class is a utility class for handling JSON Web Tokens (JWTs) in the Templehs application.
 * It provides methods for initializing the service, setting interceptors, and handling authentication.
 */
class JwtService extends TemplehsUtils.EventEmitter {
	/**
